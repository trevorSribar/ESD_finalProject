      ...
      00205B                        462 _numTimerInterrupts::
      00205B                        463 	.ds 1
                                    464 	.area HOME    (CODE)
      ...
      0005A7 43 8F 02         [24]  507 	orl	_CKCON0,#0x02
                                    508 ;	src/timer.c:20: currentTime.mseconds = 0;
      0005AA 90 20 3C         [24]  509 	mov	dptr,#(_currentTime + 0x0002)
      0005AD E4               [12]  510 	clr	a
      0005AE F0               [24]  511 	movx	@dptr,a
                                    512 ;	src/timer.c:21: currentTime.seconds = 0;
      0005AF 90 20 3B         [24]  513 	mov	dptr,#(_currentTime + 0x0001)
      0005B2 F0               [24]  514 	movx	@dptr,a
                                    515 ;	src/timer.c:22: currentTime.minutes = 0;
      0005B3 90 20 3A         [24]  516 	mov	dptr,#_currentTime
      0005B6 F0               [24]  517 	movx	@dptr,a
                                    518 ;	src/timer.c:24: TMOD |= TIMER0_16BIT_MODE; // set the timer to 16 bit mode
      0005B7 43 89 01         [24]  519 	orl	_TMOD,#0x01
                                    520 ;	src/timer.c:25: IEN0 |= TIMER0_INT_EN;  // enable timer0 interrupt
      0005BA 43 A8 02         [24]  521 	orl	_IEN0,#0x02
                                    522 ;	src/timer.c:26: IEN0 |= ALL_INTERRUPTS; // enable all interrupts
      0005BD 43 A8 80         [24]  523 	orl	_IEN0,#0x80
                                    524 ;	src/timer.c:27: TCON |= TIMER0_RUN; // starts running the timer
      0005C0 43 88 10         [24]  525 	orl	_TCON,#0x10
                                    526 ;	src/timer.c:28: }
      0005C3 22               [24]  527 	ret
                                    528 ;------------------------------------------------------------
                                    ...
                                    534 ;	-----------------------------------------
      0005C4                        535 _timer0_pause:
                                    536 ;	src/timer.c:32: TCON &= ~(TIMER0_RUN);
      0005C4 53 88 EF         [24]  537 	anl	_TCON,#0xef
                                    538 ;	src/timer.c:33: }
      0005C7 22               [24]  539 	ret
                                    540 ;------------------------------------------------------------
                                    ...
                                    546 ;	-----------------------------------------
      0005C8                        547 _timer0_resume:
                                    548 ;	src/timer.c:37: TCON |= (TIMER0_RUN);
      0005C8 43 88 10         [24]  549 	orl	_TCON,#0x10
                                    550 ;	src/timer.c:38: }
      0005CB 22               [24]  551 	ret
                                    552 ;------------------------------------------------------------
                                    ...
                                    558 ;	-----------------------------------------
      0005CC                        559 _timer0_reset:
                                    560 ;	src/timer.c:42: IEN0 &= ~TIMER0_INT_EN;
      0005CC 53 A8 FC         [24]  561 	anl	_IEN0,#0xfc
                                    562 ;	src/timer.c:43: currentTime.minutes = 0;
      0005CF 90 20 3A         [24]  563 	mov	dptr,#_currentTime
      0005D2 E4               [12]  564 	clr	a
      0005D3 F0               [24]  565 	movx	@dptr,a
                                    566 ;	src/timer.c:44: currentTime.seconds = 0;
      0005D4 90 20 3B         [24]  567 	mov	dptr,#(_currentTime + 0x0001)
      0005D7 F0               [24]  568 	movx	@dptr,a
                                    569 ;	src/timer.c:45: currentTime.mseconds = 0;
      0005D8 90 20 3C         [24]  570 	mov	dptr,#(_currentTime + 0x0002)
      0005DB F0               [24]  571 	movx	@dptr,a
                                    572 ;	src/timer.c:46: TH0 = 0;
      0005DC F5 8C            [12]  573 	mov	_TH0,a
                                    574 ;	src/timer.c:47: TL0 = 0;
      0005DE F5 8A            [12]  575 	mov	_TL0,a
                                    576 ;	src/timer.c:48: TMOD |= TIMER0_16BIT_MODE;
      0005E0 43 89 01         [24]  577 	orl	_TMOD,#0x01
                                    578 ;	src/timer.c:49: }
      0005E3 22               [24]  579 	ret
                                    580 ;------------------------------------------------------------
                                    ...
                                    586 ;	-----------------------------------------
      0005E4                        587 _timer0_getTime:
                                    588 ;	src/timer.c:53: while(numTimerInterrupts>0){
      0005E4                        589 00105$:
      0005E4 90 20 5B         [24]  590 	mov	dptr,#_numTimerInterrupts
      0005E7 E0               [24]  591 	movx	a,@dptr
      0005E8 FF               [12]  592 	mov	r7,a
      0005E9 E0               [24]  593 	movx	a,@dptr
      0005EA 60 47            [24]  594 	jz	00107$
                                    595 ;	src/timer.c:54: numTimerInterrupts--;
      0005EC EF               [12]  596 	mov	a,r7
      0005ED 14               [12]  597 	dec	a
      0005EE 90 20 5B         [24]  598 	mov	dptr,#_numTimerInterrupts
      0005F1 F0               [24]  599 	movx	@dptr,a
                                    600 ;	src/timer.c:55: currentTime.mseconds+=MS_IRQ;
      0005F2 90 20 3C         [24]  601 	mov	dptr,#(_currentTime + 0x0002)
      0005F5 E0               [24]  602 	movx	a,@dptr
      0005F6 24 07            [12]  603 	add	a,#0x07
                                    604 ;	src/timer.c:56: if(currentTime.mseconds>=MS_PER_SEC){
      0005F8 90 20 3C         [24]  605 	mov	dptr,#(_currentTime + 0x0002)
      0005FB F0               [24]  606 	movx	@dptr,a
      0005FC FF               [12]  607 	mov	r7,a
      0005FD BF 64 00         [24]  608 	cjne	r7,#0x64,00135$
      000600                        609 00135$:
      000600 40 E2            [24]  610 	jc	00105$
                                    611 ;	src/timer.c:57: currentTime.mseconds-=MS_PER_SEC;
      000602 90 20 3C         [24]  612 	mov	dptr,#(_currentTime + 0x0002)
      000605 E0               [24]  613 	movx	a,@dptr
      000606 24 9C            [12]  614 	add	a,#0x9c
      000608 90 20 3C         [24]  615 	mov	dptr,#(_currentTime + 0x0002)
      00060B F0               [24]  616 	movx	@dptr,a
                                    617 ;	src/timer.c:58: currentTime.seconds++;
      00060C 90 20 3B         [24]  618 	mov	dptr,#(_currentTime + 0x0001)
      00060F E0               [24]  619 	movx	a,@dptr
      000610 FF               [12]  620 	mov	r7,a
      000611 0F               [12]  621 	inc	r7
      000612 90 20 3B         [24]  622 	mov	dptr,#(_currentTime + 0x0001)
      000615 EF               [12]  623 	mov	a,r7
      000616 F0               [24]  624 	movx	@dptr,a
                                    625 ;	src/timer.c:59: if(currentTime.seconds>=SEC_PER_MIN){
      000617 BF 3C 00         [24]  626 	cjne	r7,#0x3c,00137$
      00061A                        627 00137$:
      00061A 40 C8            [24]  628 	jc	00105$
                                    629 ;	src/timer.c:60: currentTime.seconds-=SEC_PER_MIN;
      00061C 90 20 3B         [24]  630 	mov	dptr,#(_currentTime + 0x0001)
      00061F E0               [24]  631 	movx	a,@dptr
      000620 24 C4            [12]  632 	add	a,#0xc4
      000622 90 20 3B         [24]  633 	mov	dptr,#(_currentTime + 0x0001)
      000625 F0               [24]  634 	movx	@dptr,a
                                    635 ;	src/timer.c:61: currentTime.minutes++;
      000626 90 20 3A         [24]  636 	mov	dptr,#_currentTime
      000629 E0               [24]  637 	movx	a,@dptr
      00062A FF               [12]  638 	mov	r7,a
      00062B 0F               [12]  639 	inc	r7
      00062C 90 20 3A         [24]  640 	mov	dptr,#_currentTime
      00062F EF               [12]  641 	mov	a,r7
      000630 F0               [24]  642 	movx	@dptr,a
      000631 80 B1            [24]  643 	sjmp	00105$
      000633                        644 00107$:
                                    645 ;	src/timer.c:65: return &currentTime;
      000633 90 20 3A         [24]  646 	mov	dptr,#_currentTime
      000636 75 F0 00         [24]  647 	mov	b, #0x00
                                    648 ;	src/timer.c:66: }
      000639 22               [24]  649 	ret
                                    650 	.area CSEG    (CODE)
                                    651 	.area CONST   (CODE)
                                    652 	.area XINIT   (CODE)
      000D6E                        653 __xinit__numTimerInterrupts:
      000D6E 00                     654 	.db #0x00	; 0

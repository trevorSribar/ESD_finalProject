      ...
      0002CC                        497 _putchar:
                           ...
                           000001   504 	ar1 = 0x01
                           000000   505 	ar0 = 0x00
      0002CC AF 83            [24]  506 	mov	r7,dph
      0002CE E5 82            [12]  507 	mov	a,dpl
      0002D0 90 00 07         [24]  508 	mov	dptr,#_putchar_c_10000_79
      0002D3 F0               [24]  509 	movx	@dptr,a
      0002D4 EF               [12]  510 	mov	a,r7
      0002D5 A3               [24]  511 	inc	dptr
      0002D6 F0               [24]  512 	movx	@dptr,a
                                    513 ;	src/my_serial.c:20: while (!TI){
      0002D7                        514 00103$:
      0002D7 20 99 07         [24]  515 	jb	_TI,00105$
                                    516 ;	src/my_serial.c:21: if (IE1){
      0002DA 30 8B FA         [24]  517 	jnb	_IE1,00103$
                                    518 ;	src/my_serial.c:22: return 0;
      0002DD 90 00 00         [24]  519 	mov	dptr,#0x0000
      0002E0 22               [24]  520 	ret
      0002E1                        521 00105$:
                                    522 ;	src/my_serial.c:26: TI = 0;   // clear TI flag
                                    523 ;	assignBit
      0002E1 C2 99            [12]  524 	clr	_TI
                                    525 ;	src/my_serial.c:27: SBUF = c; // load serial port with transmit value
      0002E3 90 00 07         [24]  526 	mov	dptr,#_putchar_c_10000_79
      0002E6 E0               [24]  527 	movx	a,@dptr
      0002E7 FE               [12]  528 	mov	r6,a
      0002E8 A3               [24]  529 	inc	dptr
      0002E9 E0               [24]  530 	movx	a,@dptr
      0002EA FF               [12]  531 	mov	r7,a
      0002EB 8E 99            [24]  532 	mov	_SBUF,r6
                                    533 ;	src/my_serial.c:28: return c;
      0002ED 8E 82            [24]  534 	mov	dpl, r6
      0002EF 8F 83            [24]  535 	mov	dph, r7
                                    536 ;	src/my_serial.c:29: }
      0002F1 22               [24]  537 	ret
                                    538 ;------------------------------------------------------------
      ...
      0002F2                        547 00103$:
      0002F2 20 98 07         [24]  548 	jb	_RI,00105$
                                    549 ;	src/my_serial.c:34: if(IE1){
      0002F5 30 8B FA         [24]  550 	jnb	_IE1,00103$
                                    551 ;	src/my_serial.c:35: return 0;
      0002F8 90 00 00         [24]  552 	mov	dptr,#0x0000
      0002FB 22               [24]  553 	ret
      0002FC                        554 00105$:
                                    555 ;	src/my_serial.c:39: RI = 0;      // clear RI flag
                                    556 ;	assignBit
      0002FC C2 98            [12]  557 	clr	_RI
                                    558 ;	src/my_serial.c:40: return SBUF; // return character from SBUF
      0002FE AE 99            [24]  559 	mov	r6,_SBUF
      000300 7F 00            [12]  560 	mov	r7,#0x00
      000302 8E 82            [24]  561 	mov	dpl, r6
      000304 8F 83            [24]  562 	mov	dph, r7
                                    563 ;	src/my_serial.c:41: }
      000306 22               [24]  564 	ret
                                    565 ;------------------------------------------------------------
                                    ...
                                    571 ;	-----------------------------------------
      000307                        572 _getandputchar:
                                    573 ;	src/my_serial.c:45: while (!RI){
      000307                        574 00103$:
      000307 20 98 07         [24]  575 	jb	_RI,00105$
                                    576 ;	src/my_serial.c:46: if (IE1){
      00030A 30 8B FA         [24]  577 	jnb	_IE1,00103$
                                    578 ;	src/my_serial.c:47: return 0;
      00030D 90 00 00         [24]  579 	mov	dptr,#0x0000
      000310 22               [24]  580 	ret
      000311                        581 00105$:
                                    582 ;	src/my_serial.c:51: RI = 0; // clear RI flag
                                    583 ;	assignBit
      000311 C2 98            [12]  584 	clr	_RI
                                    585 ;	src/my_serial.c:52: while (!TI){
      000313                        586 00108$:
      000313 20 99 07         [24]  587 	jb	_TI,00110$
                                    588 ;	src/my_serial.c:53: if (IE1){
      000316 30 8B FA         [24]  589 	jnb	_IE1,00108$
                                    590 ;	src/my_serial.c:54: return 0;
      000319 90 00 00         [24]  591 	mov	dptr,#0x0000
      00031C 22               [24]  592 	ret
      00031D                        593 00110$:
                                    594 ;	src/my_serial.c:58: TI = 0;   // clear TI flag
                                    595 ;	assignBit
      00031D C2 99            [12]  596 	clr	_TI
                                    597 ;	src/my_serial.c:59: SBUF = SBUF; // load serial port with transmit value
      00031F 85 99 99         [24]  598 	mov	_SBUF,_SBUF
                                    599 ;	src/my_serial.c:60: return SBUF;
      000322 AE 99            [24]  600 	mov	r6,_SBUF
      000324 7F 00            [12]  601 	mov	r7,#0x00
      000326 8E 82            [24]  602 	mov	dpl, r6
      000328 8F 83            [24]  603 	mov	dph, r7
                                    604 ;	src/my_serial.c:61: }
      00032A 22               [24]  605 	ret
                                    606 ;------------------------------------------------------------
                                    ...
                                    614 ;	-----------------------------------------
      00032B                        615 _serial_initX2:
      00032B E5 82            [12]  616 	mov	a,dpl
      00032D 90 00 09         [24]  617 	mov	dptr,#_serial_initX2_baudRate_10000_93
      000330 F0               [24]  618 	movx	@dptr,a
                                    619 ;	src/my_serial.c:65: TH1 = baudRate;
      000331 E0               [24]  620 	movx	a,@dptr
      000332 FF               [12]  621 	mov	r7,a
      000333 8F 8D            [24]  622 	mov	_TH1,r7
                                    623 ;	src/my_serial.c:66: TL1 = baudRate;
      000335 8F 8B            [24]  624 	mov	_TL1,r7
                                    625 ;	src/my_serial.c:73: __endasm;
      000337 75 89 21         [24]  626 	mov	tmod, #0x21 ;set timer #1 for 8 bit auto-reload
      00033A 75 87 80         [24]  627 	mov	pcon, #0x80 ;configure built-in uart
      00033D 75 98 52         [24]  628 	mov	scon, #0x52
      000340 D2 8E            [12]  629 	setb	tr1 ;start the baud rate timer
                                    630 ;	src/my_serial.c:74: CKCON0 |= X2_MODE; //set the clock to X2 mode
      000342 43 8F 01         [24]  631 	orl	_CKCON0,#0x01
                                    632 ;	src/my_serial.c:75: CKCON0 |= TIMER1_SPEED; //slow down the baud rate
      000345 43 8F 04         [24]  633 	orl	_CKCON0,#0x04
                                    634 ;	src/my_serial.c:76: }
      000348 22               [24]  635 	ret
                                    636 	.area CSEG    (CODE)
                                    637 	.area CONST   (CODE)
                                    638 	.area XINIT   (CODE)

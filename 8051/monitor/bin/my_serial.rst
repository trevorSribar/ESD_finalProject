      ...
      000000                        421 	.ds 8
                                    ...
                                    448 ;--------------------------------------------------------
                                    449 	.area XSEG    (XDATA)
      00000B                        450 _putchar_c_10000_79:
      00000B                        451 	.ds 2
      00000D                        452 _serial_initX2_baudRate_10000_93:
      00000D                        453 	.ds 1
                                    454 ;--------------------------------------------------------
      ...
      000240                        497 _putchar:
                           ...
                           000001   504 	ar1 = 0x01
                           000000   505 	ar0 = 0x00
      000240 AF 83            [24]  506 	mov	r7,dph
      000242 E5 82            [12]  507 	mov	a,dpl
      000244 90 00 0B         [24]  508 	mov	dptr,#_putchar_c_10000_79
      000247 F0               [24]  509 	movx	@dptr,a
      000248 EF               [12]  510 	mov	a,r7
      000249 A3               [24]  511 	inc	dptr
      00024A F0               [24]  512 	movx	@dptr,a
                                    513 ;	src/my_serial.c:20: while (!TI){
      00024B                        514 00103$:
      00024B 20 99 07         [24]  515 	jb	_TI,00105$
                                    516 ;	src/my_serial.c:21: if (IE1){
      00024E 30 8B FA         [24]  517 	jnb	_IE1,00103$
                                    518 ;	src/my_serial.c:22: return 0;
      000251 90 00 00         [24]  519 	mov	dptr,#0x0000
      000254 22               [24]  520 	ret
      000255                        521 00105$:
                                    522 ;	src/my_serial.c:26: TI = 0;   // clear TI flag
                                    523 ;	assignBit
      000255 C2 99            [12]  524 	clr	_TI
                                    525 ;	src/my_serial.c:27: SBUF = c; // load serial port with transmit value
      000257 90 00 0B         [24]  526 	mov	dptr,#_putchar_c_10000_79
      00025A E0               [24]  527 	movx	a,@dptr
      00025B FE               [12]  528 	mov	r6,a
      00025C A3               [24]  529 	inc	dptr
      00025D E0               [24]  530 	movx	a,@dptr
      00025E FF               [12]  531 	mov	r7,a
      00025F 8E 99            [24]  532 	mov	_SBUF,r6
                                    533 ;	src/my_serial.c:28: return c;
      000261 8E 82            [24]  534 	mov	dpl, r6
      000263 8F 83            [24]  535 	mov	dph, r7
                                    536 ;	src/my_serial.c:29: }
      000265 22               [24]  537 	ret
                                    538 ;------------------------------------------------------------
      ...
      000266                        547 00103$:
      000266 20 98 07         [24]  548 	jb	_RI,00105$
                                    549 ;	src/my_serial.c:34: if(IE1){
      000269 30 8B FA         [24]  550 	jnb	_IE1,00103$
                                    551 ;	src/my_serial.c:35: return 0;
      00026C 90 00 00         [24]  552 	mov	dptr,#0x0000
      00026F 22               [24]  553 	ret
      000270                        554 00105$:
                                    555 ;	src/my_serial.c:39: RI = 0;      // clear RI flag
                                    556 ;	assignBit
      000270 C2 98            [12]  557 	clr	_RI
                                    558 ;	src/my_serial.c:40: return SBUF; // return character from SBUF
      000272 AE 99            [24]  559 	mov	r6,_SBUF
      000274 7F 00            [12]  560 	mov	r7,#0x00
      000276 8E 82            [24]  561 	mov	dpl, r6
      000278 8F 83            [24]  562 	mov	dph, r7
                                    563 ;	src/my_serial.c:41: }
      00027A 22               [24]  564 	ret
                                    565 ;------------------------------------------------------------
                                    ...
                                    571 ;	-----------------------------------------
      00027B                        572 _getandputchar:
                                    573 ;	src/my_serial.c:45: while (!RI){
      00027B                        574 00103$:
      00027B 20 98 07         [24]  575 	jb	_RI,00105$
                                    576 ;	src/my_serial.c:46: if (IE1){
      00027E 30 8B FA         [24]  577 	jnb	_IE1,00103$
                                    578 ;	src/my_serial.c:47: return 0;
      000281 90 00 00         [24]  579 	mov	dptr,#0x0000
      000284 22               [24]  580 	ret
      000285                        581 00105$:
                                    582 ;	src/my_serial.c:51: RI = 0; // clear RI flag
                                    583 ;	assignBit
      000285 C2 98            [12]  584 	clr	_RI
                                    585 ;	src/my_serial.c:52: while (!TI){
      000287                        586 00108$:
      000287 20 99 07         [24]  587 	jb	_TI,00110$
                                    588 ;	src/my_serial.c:53: if (IE1){
      00028A 30 8B FA         [24]  589 	jnb	_IE1,00108$
                                    590 ;	src/my_serial.c:54: return 0;
      00028D 90 00 00         [24]  591 	mov	dptr,#0x0000
      000290 22               [24]  592 	ret
      000291                        593 00110$:
                                    594 ;	src/my_serial.c:58: TI = 0;   // clear TI flag
                                    595 ;	assignBit
      000291 C2 99            [12]  596 	clr	_TI
                                    597 ;	src/my_serial.c:59: SBUF = SBUF; // load serial port with transmit value
      000293 85 99 99         [24]  598 	mov	_SBUF,_SBUF
                                    599 ;	src/my_serial.c:60: return SBUF;
      000296 AE 99            [24]  600 	mov	r6,_SBUF
      000298 7F 00            [12]  601 	mov	r7,#0x00
      00029A 8E 82            [24]  602 	mov	dpl, r6
      00029C 8F 83            [24]  603 	mov	dph, r7
                                    604 ;	src/my_serial.c:61: }
      00029E 22               [24]  605 	ret
                                    606 ;------------------------------------------------------------
                                    ...
                                    614 ;	-----------------------------------------
      00029F                        615 _serial_initX2:
      00029F E5 82            [12]  616 	mov	a,dpl
      0002A1 90 00 0D         [24]  617 	mov	dptr,#_serial_initX2_baudRate_10000_93
      0002A4 F0               [24]  618 	movx	@dptr,a
                                    619 ;	src/my_serial.c:65: TH1 = baudRate;
      0002A5 E0               [24]  620 	movx	a,@dptr
      0002A6 FF               [12]  621 	mov	r7,a
      0002A7 8F 8D            [24]  622 	mov	_TH1,r7
                                    623 ;	src/my_serial.c:66: TL1 = baudRate;
      0002A9 8F 8B            [24]  624 	mov	_TL1,r7
                                    625 ;	src/my_serial.c:73: __endasm;
      0002AB 75 89 21         [24]  626 	mov	tmod, #0x21 ;set timer #1 for 8 bit auto-reload
      0002AE 75 87 80         [24]  627 	mov	pcon, #0x80 ;configure built-in uart
      0002B1 75 98 52         [24]  628 	mov	scon, #0x52
      0002B4 D2 8E            [12]  629 	setb	tr1 ;start the baud rate timer
                                    630 ;	src/my_serial.c:74: CKCON0 |= X2_MODE; //set the clock to X2 mode
      0002B6 43 8F 01         [24]  631 	orl	_CKCON0,#0x01
                                    632 ;	src/my_serial.c:75: CKCON0 |= TIMER1_SPEED; //slow down the baud rate
      0002B9 43 8F 04         [24]  633 	orl	_CKCON0,#0x04
                                    634 ;	src/my_serial.c:76: }
      0002BC 22               [24]  635 	ret
                                    636 	.area CSEG    (CODE)
                                    637 	.area CONST   (CODE)
                                    638 	.area XINIT   (CODE)

      ...
      0002C2                        497 _putchar:
                           ...
                           000001   504 	ar1 = 0x01
                           000000   505 	ar0 = 0x00
      0002C2 AF 83            [24]  506 	mov	r7,dph
      0002C4 E5 82            [12]  507 	mov	a,dpl
      0002C6 90 00 07         [24]  508 	mov	dptr,#_putchar_c_10000_79
      0002C9 F0               [24]  509 	movx	@dptr,a
      0002CA EF               [12]  510 	mov	a,r7
      0002CB A3               [24]  511 	inc	dptr
      0002CC F0               [24]  512 	movx	@dptr,a
                                    513 ;	src/my_serial.c:20: while (!TI){
      0002CD                        514 00103$:
      0002CD 20 99 07         [24]  515 	jb	_TI,00105$
                                    516 ;	src/my_serial.c:21: if (IE1){
      0002D0 30 8B FA         [24]  517 	jnb	_IE1,00103$
                                    518 ;	src/my_serial.c:22: return 0;
      0002D3 90 00 00         [24]  519 	mov	dptr,#0x0000
      0002D6 22               [24]  520 	ret
      0002D7                        521 00105$:
                                    522 ;	src/my_serial.c:26: TI = 0;   // clear TI flag
                                    523 ;	assignBit
      0002D7 C2 99            [12]  524 	clr	_TI
                                    525 ;	src/my_serial.c:27: SBUF = c; // load serial port with transmit value
      0002D9 90 00 07         [24]  526 	mov	dptr,#_putchar_c_10000_79
      0002DC E0               [24]  527 	movx	a,@dptr
      0002DD FE               [12]  528 	mov	r6,a
      0002DE A3               [24]  529 	inc	dptr
      0002DF E0               [24]  530 	movx	a,@dptr
      0002E0 FF               [12]  531 	mov	r7,a
      0002E1 8E 99            [24]  532 	mov	_SBUF,r6
                                    533 ;	src/my_serial.c:28: return c;
      0002E3 8E 82            [24]  534 	mov	dpl, r6
      0002E5 8F 83            [24]  535 	mov	dph, r7
                                    536 ;	src/my_serial.c:29: }
      0002E7 22               [24]  537 	ret
                                    538 ;------------------------------------------------------------
      ...
      0002E8                        547 00103$:
      0002E8 20 98 07         [24]  548 	jb	_RI,00105$
                                    549 ;	src/my_serial.c:34: if(IE1){
      0002EB 30 8B FA         [24]  550 	jnb	_IE1,00103$
                                    551 ;	src/my_serial.c:35: return 0;
      0002EE 90 00 00         [24]  552 	mov	dptr,#0x0000
      0002F1 22               [24]  553 	ret
      0002F2                        554 00105$:
                                    555 ;	src/my_serial.c:39: RI = 0;      // clear RI flag
                                    556 ;	assignBit
      0002F2 C2 98            [12]  557 	clr	_RI
                                    558 ;	src/my_serial.c:40: return SBUF; // return character from SBUF
      0002F4 AE 99            [24]  559 	mov	r6,_SBUF
      0002F6 7F 00            [12]  560 	mov	r7,#0x00
      0002F8 8E 82            [24]  561 	mov	dpl, r6
      0002FA 8F 83            [24]  562 	mov	dph, r7
                                    563 ;	src/my_serial.c:41: }
      0002FC 22               [24]  564 	ret
                                    565 ;------------------------------------------------------------
                                    ...
                                    571 ;	-----------------------------------------
      0002FD                        572 _getandputchar:
                                    573 ;	src/my_serial.c:45: while (!RI){
      0002FD                        574 00103$:
      0002FD 20 98 07         [24]  575 	jb	_RI,00105$
                                    576 ;	src/my_serial.c:46: if (IE1){
      000300 30 8B FA         [24]  577 	jnb	_IE1,00103$
                                    578 ;	src/my_serial.c:47: return 0;
      000303 90 00 00         [24]  579 	mov	dptr,#0x0000
      000306 22               [24]  580 	ret
      000307                        581 00105$:
                                    582 ;	src/my_serial.c:51: RI = 0; // clear RI flag
                                    583 ;	assignBit
      000307 C2 98            [12]  584 	clr	_RI
                                    585 ;	src/my_serial.c:52: while (!TI){
      000309                        586 00108$:
      000309 20 99 07         [24]  587 	jb	_TI,00110$
                                    588 ;	src/my_serial.c:53: if (IE1){
      00030C 30 8B FA         [24]  589 	jnb	_IE1,00108$
                                    590 ;	src/my_serial.c:54: return 0;
      00030F 90 00 00         [24]  591 	mov	dptr,#0x0000
      000312 22               [24]  592 	ret
      000313                        593 00110$:
                                    594 ;	src/my_serial.c:58: TI = 0;   // clear TI flag
                                    595 ;	assignBit
      000313 C2 99            [12]  596 	clr	_TI
                                    597 ;	src/my_serial.c:59: SBUF = SBUF; // load serial port with transmit value
      000315 85 99 99         [24]  598 	mov	_SBUF,_SBUF
                                    599 ;	src/my_serial.c:60: return SBUF;
      000318 AE 99            [24]  600 	mov	r6,_SBUF
      00031A 7F 00            [12]  601 	mov	r7,#0x00
      00031C 8E 82            [24]  602 	mov	dpl, r6
      00031E 8F 83            [24]  603 	mov	dph, r7
                                    604 ;	src/my_serial.c:61: }
      000320 22               [24]  605 	ret
                                    606 ;------------------------------------------------------------
                                    ...
                                    614 ;	-----------------------------------------
      000321                        615 _serial_initX2:
      000321 E5 82            [12]  616 	mov	a,dpl
      000323 90 00 09         [24]  617 	mov	dptr,#_serial_initX2_baudRate_10000_93
      000326 F0               [24]  618 	movx	@dptr,a
                                    619 ;	src/my_serial.c:65: TH1 = baudRate;
      000327 E0               [24]  620 	movx	a,@dptr
      000328 FF               [12]  621 	mov	r7,a
      000329 8F 8D            [24]  622 	mov	_TH1,r7
                                    623 ;	src/my_serial.c:66: TL1 = baudRate;
      00032B 8F 8B            [24]  624 	mov	_TL1,r7
                                    625 ;	src/my_serial.c:73: __endasm;
      00032D 75 89 21         [24]  626 	mov	tmod, #0x21 ;set timer #1 for 8 bit auto-reload
      000330 75 87 80         [24]  627 	mov	pcon, #0x80 ;configure built-in uart
      000333 75 98 52         [24]  628 	mov	scon, #0x52
      000336 D2 8E            [12]  629 	setb	tr1 ;start the baud rate timer
                                    630 ;	src/my_serial.c:74: CKCON0 |= X2_MODE; //set the clock to X2 mode
      000338 43 8F 01         [24]  631 	orl	_CKCON0,#0x01
                                    632 ;	src/my_serial.c:75: CKCON0 |= TIMER1_SPEED; //slow down the baud rate
      00033B 43 8F 04         [24]  633 	orl	_CKCON0,#0x04
                                    634 ;	src/my_serial.c:76: }
      00033E 22               [24]  635 	ret
                                    636 	.area CSEG    (CODE)
                                    637 	.area CONST   (CODE)
                                    638 	.area XINIT   (CODE)

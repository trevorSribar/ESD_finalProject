...
_lcd_initdelay_delayAmount_10000_129:
	.ds 4
_Terminal_run_receivedCharacter_10001_146:
	.ds 1
_Terminal_Timer_receivedCharacter_10000_152:
	.ds 1
_getInputOfSize_PARM_2:
	.ds 1
_getInputOfSize_input_10000_157:
	.ds 3
_getInputString_PARM_2:
	.ds 3
_getInputString_PARM_3:
	.ds 1
_getInputString_string_10000_162:
	.ds 3
_getInputString_inChar_10000_163:
	.ds 1
_getandputcharUpdate_inputChar_10000_166:
	.ds 3
;--------------------------------------------------------
...
;------------------------------------------------------------
;receivedCharacter Allocated with name '_Terminal_run_receivedCharacter_10001_146'
;------------------------------------------------------------
...
;	src/terminal.c:15: getandputcharUpdate(&receivedCharacter);
	mov	dptr,#_Terminal_run_receivedCharacter_10001_146
	mov	b, #0x00
...
;	src/terminal.c:27: return 0;
;	src/terminal.c:28: }
	sjmp	00105$
;------------------------------------------------------------
;Allocation info for local variables in function 'Terminal_Help'
;------------------------------------------------------------
;	src/terminal.c:30: void Terminal_Help(){
;	-----------------------------------------
;	 function Terminal_Help
;	-----------------------------------------
_Terminal_Help:
;	src/terminal.c:31: printf_tiny("\n\r --- COMMAND HELP MENU --- \n\r");
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	src/terminal.c:33: printf_tiny("? -- This help menu, shows valid commands.\n\r");
	mov	a,#___str_4
	push	acc
	mov	a,#(___str_4 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	src/terminal.c:36: printf_tiny("p -- pauses the LCD.\n\r");
	mov	a,#___str_5
	push	acc
	mov	a,#(___str_5 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	src/terminal.c:37: printf_tiny("r -- resumes the LCD\n\r");
	mov	a,#___str_6
	push	acc
	mov	a,#(___str_6 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	src/terminal.c:40: printf_tiny("reset -- restarts the program.\n\r");
	mov	a,#___str_7
	push	acc
	mov	a,#(___str_7 >> 8)
	push	acc
...
;------------------------------------------------------------
;receivedCharacter Allocated with name '_Terminal_Timer_receivedCharacter_10000_152'
;------------------------------------------------------------
;	src/terminal.c:43: void Terminal_Timer(){
;	-----------------------------------------
;	 function Terminal_Timer
;	-----------------------------------------
_Terminal_Timer:
;	src/terminal.c:45: getandputcharUpdate(&receivedCharacter);
	mov	dptr,#_Terminal_Timer_receivedCharacter_10000_152
	mov	b, #0x00
	lcall	_getandputcharUpdate
;	src/terminal.c:46: switch(receivedCharacter){
	mov	dptr,#_Terminal_Timer_receivedCharacter_10000_152
	movx	a,@dptr
	mov	r7,a
	cjne	r7,#0x63,00125$
...
00126$:
	cjne	r7,#0x73,00105$
;	src/terminal.c:48: timer0_pause();
	lcall	_timer0_pause
;	src/terminal.c:49: printf_tiny("\n\rTimer stopped.\n\r");
	mov	a,#___str_8
	push	acc
	mov	a,#(___str_8 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	src/terminal.c:50: break;
;	src/terminal.c:52: case 'r' :{
	ret
00102$:
;	src/terminal.c:53: timer0_resume();
	lcall	_timer0_resume
;	src/terminal.c:54: printf_tiny("\n\rTimer resumed.\n\r");
	mov	a,#___str_9
	push	acc
	mov	a,#(___str_9 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
;	src/terminal.c:55: break;
;	src/terminal.c:57: case 'c':{
	ret
00103$:
;	src/terminal.c:58: timer0_reset();
	lcall	_timer0_reset
;	src/terminal.c:59: printf_tiny("\n\rTimer reset\n\r");
	mov	a,#___str_10
	push	acc
	mov	a,#(___str_10 >> 8)
	push	acc
...
;input         Allocated with name '_getInputOfSize_input_10000_157'
;inChar        Allocated with name '_getInputOfSize_inChar_10000_158'
;i             Allocated with name '_getInputOfSize_i_20000_159'
;------------------------------------------------------------
;	src/terminal.c:65: uint8_t getInputOfSize(uint16_t *input, uint8_t numChars){
;	-----------------------------------------
...
_getInputOfSize:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_getInputOfSize_input_10000_157
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;	src/terminal.c:67: *input = 0;
	...
	inc	dptr
	lcall	__gptrput
;	src/terminal.c:69: for(uint8_t i = 0; i<numChars;i++){
...
00110$:
	...
	ljmp	00108$
00144$:
;	src/terminal.c:70: inChar = getchar();
	push	ar7
	push	ar6
	lcall	_getchar
	mov	r4, dpl
	pop	ar6
	pop	ar7
;	src/terminal.c:71: if(i!=0 && (inChar=='\r' || inChar=='\n')){
	mov	a,r6
	jz	00102$
	cjne	r4,#0x0d,00146$
	sjmp	00101$
00146$:
	cjne	r4,#0x0a,00102$
00101$:
;	src/terminal.c:72: return 0;
	mov	dpl, #0x00
	ret
00102$:
;	src/terminal.c:74: putchar(inChar);               // print the charcter the user typed in
	mov	ar3,r4
	mov	r5,#0x00
	mov	dpl, r3
	mov	dph, r5
	...
	pop	ar6
	pop	ar7
;	src/terminal.c:75: if (inChar < '0' || inChar > '9')
	cjne	r4,#0x30,00149$
00149$:
	jc	00105$
	mov	a,r4
	...
	jnc	00106$
00105$:
;	src/terminal.c:76: return -1;             // Check if the current character is a digit
	mov	dpl, #0xff
	ret
00106$:
;	src/terminal.c:77: *input = 10 * *input + (inChar - '0'); // add digit to 10s place
	push	ar7
	mov	dptr,#_getInputOfSize_input_10000_157
	movx	a,@dptr
	mov	r1,a
...
;string        Allocated with name '_getInputString_string_10000_162'
;inChar        Allocated with name '_getInputString_inChar_10000_163'
;currentSize   Allocated with name '_getInputString_currentSize_10001_164'
;------------------------------------------------------------
;	src/terminal.c:82: void getInputString(char *string, uint16_t *size, uint8_t maxSize){
;	-----------------------------------------
...
_getInputString:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_getInputString_string_10000_162
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	src/terminal.c:84: getandputcharUpdate(&inChar);
	mov	dptr,#_getInputString_inChar_10000_163
	mov	b, #0x00
	lcall	_getandputcharUpdate
;	src/terminal.c:87: while(!(inChar=='\r' || inChar=='\n')){
	mov	dptr,#_getInputString_string_10000_162
	movx	a,@dptr
...
00134$:
	...
	sjmp	00106$
00135$:
;	src/terminal.c:88: string[currentSize] = inChar;
	mov	a,r3
	...
	mov	a,r2
	lcall	__gptrput
;	src/terminal.c:89: currentSize++;
	inc	r3
	cjne	r3,#0x00,00136$
	inc	r4
00136$:
;	src/terminal.c:90: if(currentSize==maxSize)
	...
	sjmp	00106$
00137$:
;	src/terminal.c:92: getandputcharUpdate(&inChar);
	mov	dptr,#_getInputString_inChar_10000_163
	mov	b, #0x00
	push	ar4
	push	ar3
	...
	sjmp	00104$
00106$:
;	src/terminal.c:94: *size = currentSize;
...
;------------------------------------------------------------
;inputChar     Allocated with name '_getandputcharUpdate_inputChar_10000_166'
;------------------------------------------------------------
;	src/terminal.c:98: void getandputcharUpdate(char *inputChar){
;	-----------------------------------------
...
_getandputcharUpdate:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#_getandputcharUpdate_inputChar_10000_166
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
	...
	inc	dptr
	movx	@dptr,a
;	src/terminal.c:99: while(!RI){
00103$:
	jb	_RI,00105$
;	src/terminal.c:100: if(numTimerInterrupts>0){
	mov	dptr,#_numTimerInterrupts
	movx	a,@dptr
	jz	00103$
;	src/terminal.c:101: numTimerInterrupts=0;
	mov	dptr,#_numTimerInterrupts
	clr	a
	movx	@dptr,a
	sjmp	00103$
00105$:
;	src/terminal.c:104: *inputChar = getandputchar();
	mov	dptr,#_getandputcharUpdate_inputChar_10000_166
	movx	a,@dptr
	mov	r5,a
	inc	dptr

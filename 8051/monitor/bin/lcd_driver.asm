...
;	assignBit
	clr	_P3_4
;	src/lcd_driver.c:17: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
...
00174$:
	...
	cjne	r5,#0x00,00224$
	inc	r6
;	src/lcd_driver.c:19: lcd_initdelay(LCD_DELAY_120_MS);
	cjne	r6,#0x00,00174$
	inc	r7
00224$:
	sjmp	00174$
...
00177$:
	...
	cjne	r5,#0x00,00226$
	inc	r6
;	src/lcd_driver.c:23: lcd_initdelay(LCD_DELAY_120_MS);
	cjne	r6,#0x00,00177$
	inc	r7
00226$:
	sjmp	00177$
...
;	headers/lcd_driver.h:53: *writeToLCD = address;
	...
	movx	@dptr,a
	movx	@dptr,a
;	src/lcd_driver.c:40: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
...
;	headers/lcd_driver.h:53: *writeToLCD = address;
	...
	clr	a
	movx	@dptr,a
;	src/lcd_driver.c:47: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
...
;	headers/lcd_driver.h:53: *writeToLCD = address;
	...
	movx	@dptr,a
	movx	@dptr,a
;	src/lcd_driver.c:62: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
...
;	headers/lcd_driver.h:53: *writeToLCD = address;
	...
	clr	a
	movx	@dptr,a
;	src/lcd_driver.c:71: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
...
;	headers/lcd_driver.h:53: *writeToLCD = address;
	...
	clr	a
	movx	@dptr,a
;	src/lcd_driver.c:82: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
...
;	headers/lcd_driver.h:53: *writeToLCD = address;
	...
	mov	a,#0x2a
	movx	@dptr,a
;	src/lcd_driver.c:93: LCD_COMMAND_REGISTER_PIN = 1;
;	assignBit
	setb	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
	...
	mov	a,#0x3f
	movx	@dptr,a
;	src/lcd_driver.c:100: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
...
;	headers/lcd_driver.h:53: *writeToLCD = address;
	...
	mov	a,#0xdf
	movx	@dptr,a
;	src/lcd_driver.c:109: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
	...
	mov	a,#0x51
	movx	@dptr,a
;	src/lcd_driver.c:114: LCD_COMMAND_REGISTER_PIN = 1;
;	assignBit
	setb	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800
...
00180$:
	...
	cjne	r5,#0x00,00228$
	inc	r6
;	src/lcd_driver.c:116: lcd_initdelay(LCD_DELAY_120_MS);
	cjne	r6,#0x00,00180$
	inc	r7
00228$:
	sjmp	00180$
00171$:
;	src/lcd_driver.c:120: LCD_COMMAND_REGISTER_PIN = 0;
;	assignBit
	clr	_P1_7
;	headers/lcd_driver.h:53: *writeToLCD = address;
	mov	dptr,#0x0800

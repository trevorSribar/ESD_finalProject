...
;	src/main.c:21: interrupt_init();
	lcall	_interrupt_init
;	src/main.c:22: i2c_init();
	lcall	_i2c_init
;	src/main.c:24: while(Terminal_run());;
00101$:
	lcall	_Terminal_run
	mov	a, dpl
	jnz	00101$
;	src/main.c:26: printf_tiny("End program\n\r");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
...
;------------------------------------------------------------
;	src/main.c:30: void interrupt_init(void){
;	-----------------------------------------
;	 function interrupt_init
;	-----------------------------------------
_interrupt_init:
;	src/main.c:32: IEN0 |= ENABLE_INTERRUPTS;
	orl	_IEN0,#0x80
;	src/main.c:33: IEN0 |= INT0_INTERRUPT_ENABLE;
	orl	_IEN0,#0x01
;	src/main.c:34: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	src/main.c:36: void timer0_interrupt(void) __interrupt (TIMER0_INTERRUPT_NUMBER){
;	-----------------------------------------
...
_timer0_interrupt:
	...
	push	dph
	push	psw
;	src/main.c:37: numTimerInterrupts++;
	mov	dptr,#_numTimerInterrupts
	movx	a,@dptr
	add	a, #0x01
	movx	@dptr,a
;	src/main.c:38: TH0 = TIMER0_PRESCALE;
	mov	_TH0,#0x03
;	src/main.c:39: }
	pop	psw
	pop	dph
...
;------------------------------------------------------------
;	src/main.c:42: void Intr0(void) __interrupt (INT0_INTERRUPT_NUMBER) {
;	-----------------------------------------
;	 function Intr0
;	-----------------------------------------
_Intr0:
